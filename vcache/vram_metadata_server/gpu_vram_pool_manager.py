...
class GPUVRAMPoolManager:
    ...
    def __init__(self, config):
        ...
        self.metadata: Dict[VCacheKey, GPUVRAMEntry] = {}
        
        # GPU-specific metadata tracking
        self.gpu_metadata: Dict[int, Set[VCacheKey]] = {}  # gpu_id -> set of keys
    ...
    def lookup_prefix(
        self,
        token_ids: List[int],
        all_chunks: List[Tuple[int, int, VCacheKey]],
    ...
    def register_kvcache(
        ...
        Args:
            cache_key: VCacheKey generated by TokenDatabase in store function
    ...
    def batch_register_kvcache(
        self,
        entries_data: List[Tuple[VCacheKey,
                                 List[int], 
                                 int, 
                                 tuple, 
                                 torch.dtype, 
    ...
    def get_entry(self, key: VCacheKey) -> Optional[GPUVRAMEntry]:
    ...
    def batch_get_entry(self, keys: List[VCacheKey]) -> List[Optional[GPUVRAMEntry]]:
        """
