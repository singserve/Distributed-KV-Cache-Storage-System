...
class TestCacheEngineConnectorV1(KVConnectorBase_V1):
    ...
    def start_load_kv(self, forward_context: "ForwardContext", **kwargs: Any) -> None:
        ...
        # Get connector metadata - handle the case where metadata might be None
        # Similar to vllm v1 adapter, check if metadata is available
    ...
    def register_kv_caches(self, kv_caches: dict[str, torch.Tensor]):
        ...
        self.kv_caches.update(kv_caches)
        logger.info(f"Registered {len(kv_caches)} KV caches")
