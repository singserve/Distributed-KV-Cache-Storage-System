...
class Proxy:
    ...
    async def create_completion(self, raw_request: Request):
        try:
            ...
            #modified
            prefill = kv_prepare_request.get("user").get("prefill") if kv_prepare_request.get("user").get("prefill") else None
            decode = kv_prepare_request.get("user").get("decode") if kv_prepare_request.get("user").get("decode") else None
            prefill_instance =  prefill if prefill else self.schedule(self.prefill_cycler)
            ...
            decode_instance = decode if decode else self.schedule(self.decode_cycler)
